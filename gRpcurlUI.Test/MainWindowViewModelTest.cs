...
namespace gRpcurlUI.Test
{
    ...
    public class MainWindowViewModelTest
    {
        ...
        {
            var mock = new Mock<ExecutePageViewModel>();
            ExecutePageViewModel executePageViewModel = mock.Object;
        ...
        public void ImportCommand_1()
        {
            ...
            var mockContext = new Mock<IProjectContext>();
            IProjectContext projectContext = mockContext.Object;
